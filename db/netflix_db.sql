...
/****** Object:  Database [Statistix]    Script Date: 13/12/2017 14:29:05 ******/
CREATE DATABASE [Statistix]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Statistix', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\Statistix.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Statistix_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\Statistix_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Statistix] SET COMPATIBILITY_LEVEL = 140
GO
